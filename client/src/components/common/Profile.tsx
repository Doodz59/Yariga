...
return(
  <Box>
      ...
      <Box mt="20px" borderRadius="15px" padding="20px" bgcolor={theme.palette.mode === "dark" ? "#0E8388" : "#fcfcfc"}>
          <Box
              sx={{
                  display: "flex",
                  ...
                  >
                      ...
                      >
                          <Stack direction="column">
                              ...
                              <Typography fontSize={16} color={theme.palette.mode === "dark" ? "white" : "#808191"}>
                                  Realestate Agent
                              </Typography>
                          </Stack>
                          ...
                          <Stack direction="column" gap="30px">
                              <Stack gap="15px">
                                  ...
                                  <Box
                                      ...
                                      gap="10px"
                                  >
                                      <Place sx={{ color:theme.palette.mode === "dark" ? "white" : "#11142D" }} />
                                      <Typography
                                          fontSize={14}
                                          color={theme.palette.mode === "dark" ? "white" : "#11142D"}
                                      >
                              ...
                              >
                                  <Stack flex={1} gap="15px">
                                      ...
                                      <Box
                                          ...
                                          gap="10px"
                                      >
                                          <Phone sx={{ color:theme.palette.mode === "dark" ? "white" : "#11142D" }} />
                                          <Typography
                                              fontSize={14}
                                              color={theme.palette.mode === "dark" ? "white" : "#11142D"}
                                              noWrap
                                  ...
                                  <Stack flex={1} gap="15px">
                                      ...
                                      <Box
                                          ...
                                          gap="10px"
                                      >
                                          <Email sx={{ color:theme.palette.mode === "dark" ? "white" : "#11142D" }} />
                                          <Typography
                                              fontSize={14}
                                              color={theme.palette.mode === "dark" ? "white" : "#11142D"}
                                          >
